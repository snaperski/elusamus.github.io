...
Tempot kruvivad ka arengud pilvemaailmas, kus lisaks teenustele on virtualiseeritud riistvaragi ning tarkvara konteinerlahendused istutatakse pilveveerele. Säärane hajussüsteem tagab selle, et nüüd tõesti juba kõige kohta saaks öelda Everything-as-a-Service. 
